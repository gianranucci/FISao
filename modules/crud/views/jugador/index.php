 ...
 * @var app\modules\crud\models\search\Jugador $searchModel
 */
$this->title = Yii::t('models', 'Jugadors');
...
?>
<div class="giiant-crud jugador-index">
...
?>
    ...
    <h1>
        <?php echo Yii::t('models', 'Jugadors') ?>
        <small>
            List
        </small>
    </h1>
	...
	[
		...
		'dropdown' => [
			...
			'items' => [
				[
					'url' => ['/crud/gole/index'],
					'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('models', 'Gole'),
				],
				[
