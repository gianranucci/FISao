...
$form->field($model, 'rule_name')->dropDownList(
	\yii\helpers\ArrayHelper::map(app\modules\crud\models\AuthRule::find()->all(), 'name', 'name'),
	[
		'prompt' => Yii::t('cruds', 'Select'),
		'disabled' => (isset($relAttributes) && isset($relAttributes['rule_name'])),
	]
); ?>
        </p>
        <?php $this->endBlock(); ?>
