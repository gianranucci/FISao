 ...
 * @var app\modules\crud\models\search\SocialAccount $searchModel
 */
$this->title = Yii::t('models', 'Social Accounts');
...
?>
<div class="giiant-crud social-account-index">
...
?>
    ...
    <h1>
        <?php echo Yii::t('models', 'Social Accounts') ?>
        <small>
            List
        </small>
    </h1>
