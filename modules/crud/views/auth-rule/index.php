 ...
 * @var app\modules\crud\models\search\AuthRule $searchModel
 */
$this->title = Yii::t('models', 'Auth Rules');
...
?>
<div class="giiant-crud auth-rule-index">
...
?>
    ...
    <h1>
        <?php echo Yii::t('models', 'Auth Rules') ?>
        <small>
            List
        </small>
    </h1>
...
\yii\bootstrap\ButtonDropdown::widget(
	[
		...
		'dropdown' => [
			...
			'items' => [
				[
					'url' => ['/crud/auth-item/index'],
					'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('models', 'Auth Item'),
				],
