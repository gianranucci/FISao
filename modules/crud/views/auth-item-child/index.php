 ...
 * @var app\modules\crud\models\search\AuthItemChild $searchModel
 */
$this->title = Yii::t('models', 'Auth Item Children');
...
?>
<div class="giiant-crud auth-item-child-index">
...
?>
    ...
    <h1>
        <?php echo Yii::t('models', 'Auth Item Children') ?>
        <small>
            List
        </small>
    </h1>
		...
		'dropdown' => [
			...
			'items' => [
				[
					...
					'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('models', 'Auth Item'),
				],
				[
					'url' => ['/crud/auth-item/index'],
					'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('models', 'Auth Item'),
