 ...
 * @var app\modules\crud\models\search\InicioCarousel $searchModel
 */
$this->title = Yii::t('models', 'Inicio Carousels');
...
?>
<div class="giiant-crud inicio-carousel-index">
...
?>
    ...
    <h1>
        <?php echo Yii::t('models', 'Inicio Carousels') ?>
        <small>
            List
        </small>
    </h1>
