 ...
 * @var app\modules\crud\models\search\AuthAssignment $searchModel
 */
$this->title = Yii::t('models', 'Auth Assignments');
...
?>
<div class="giiant-crud auth-assignment-index">
...
?>
    ...
    <h1>
        <?php echo Yii::t('models', 'Auth Assignments') ?>
        <small>
            List
        </small>
    </h1>
