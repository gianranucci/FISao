 ...
 * @var app\modules\crud\models\search\Gole $searchModel
 */
$this->title = Yii::t('models', 'Goles');
...
?>
<div class="giiant-crud gole-index">
		...
		'dropdown' => [
			...
			'items' => [
				[
					...
					'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('models', 'Jugador'),
				],
		...
		'columns' => [
			...
			[
				...
				'value' => function ($model) {
					if ($rel = $model->jugador) {
						return Html::a($rel->id_jugador, ['/crud/jugador/view', 'id_jugador' => $rel->id_jugador, ], ['data-pjax' => 0]);
					} else {
						return '';
					}
				},
