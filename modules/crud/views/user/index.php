 ...
 * @var app\modules\crud\models\search\User $searchModel
 */
...
\yii\bootstrap\ButtonDropdown::widget(
	[
		...
		'dropdown' => [
			...
			'items' => [
				[
					'url' => ['/crud/profile/index'],
					'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('models', 'Profile'),
				],
				[
					'url' => ['/crud/social-account/index'],
					'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('models', 'Social Account'),
				],
				[
					'url' => ['/crud/token/index'],
					'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('models', 'Token'),
				],
