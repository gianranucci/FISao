 ...
 * @var app\modules\crud\models\search\Tecnico $searchModel
 */
$this->title = Yii::t('models', 'Tecnicos');
...
?>
<div class="giiant-crud tecnico-index">
...
?>
    ...
    <h1>
        <?php echo Yii::t('models', 'Tecnicos') ?>
        <small>
            List
        </small>
    </h1>
		...
		'dropdown' => [
			...
			'items' => [
				[
					...
					'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('models', 'Equipo'),
				],
